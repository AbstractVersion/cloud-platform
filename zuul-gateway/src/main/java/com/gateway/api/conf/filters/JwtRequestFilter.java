...
//    }
//    private Collection<String> excludeUrlPatterns = Arrays.asList(AUTH_WHITELIST);
...
//                throw new IOException("JWT Token has expired");
            ...
            logger.warn("JWT Token does not begin with Bearer String or Token is not present");
        }
